...
| Projekt | Info | Odkaz |
| --- | --- | --- |
| **Homebridge Manager** | Mobilní správa Homebridge pro iPhone / PWA. | [Web](https://caseycz.github.io/homebridge-manager/) |
| **GameS Calendar** | Herní kalendář a vyhledávač vydání. | [Web](https://130.61.49.108/games/) |
| **Scriptable Apps** | Widgety a nástroje pro iPhone. | [Katalog](https://caseycz.github.io/Scriptable/) |
| **Travel Checklist** | Pomocník na cesty. | [Web](https://caseycz.github.io/Checklist.html) |
